%************************************************
\chapter{Introduction for Classic Thesis}
%************************************************
...
\begin{itemize}
    ...
    \item Tweaking colors and fonts -- please use this with great care!:
        \begin{itemize}
            ...
            \item\texttt{CTsemi}: Change the semi gray color used, \eg, for the chapter number. Default is:\\
						\verb|\definecolor{CTsemi}{gray}{0.55}|

            \item\texttt{CTtitle}: Change the red color used, \eg, for the title. Default is: \\
						\verb|\definecolor{CTtitle}{named}{Maroon}|
